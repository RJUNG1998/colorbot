...
module.exports = class Error {
    ...
    inhouseEmbed() {
        return new EmbedBuilder()
            ...
            .setTitle("설명서")
            .addFields(
                { name: '`/내전 롤등록`', value: '협곡과 칼바람 내전 신청 권한을 요청합니다. <@&993627158138327151> 역할이 이미 있을 경우 불필요합니다.', inline: true},
                { name: '`/내전 발로등록`', value: '발로란트 내전 신청 권한을 요청합니다. <@&1097697913859223622> 역할이 이미 있을 경우 불필요합니다.', inline: true},
                { name: '`/내전 라인추가`', value: '협곡 내전 라인 신청 권한 증가를 요청합니다. [오피지지](https://www.op.gg/)를 기반으로 요청의 여부를 판단합니다.', inline: true},
            )
            .setFooter({ text: `𓇼PALETTE𓇼`, iconURL: `https://cdn.discordapp.com/attachments/1013114492948840540/1095783759216922654/IMG_4037.png`})
    }
}